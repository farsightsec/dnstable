...
typedef enum {
	...
	DNSTABLE_STAT_STAGE_FILTER_BAILIWICK = 2,
	DNSTABLE_STAT_STAGE_FILTER_TIME_STRICT = 3,
	DNSTABLE_STAT_STAGE_REMOVE_STRICT = 4,
	DNSTABLE_STAT_STAGE_LJOIN = 5,
	DNSTABLE_STAT_STAGE_FILTER_TIME = 6,
	DNSTABLE_STAT_STAGE_FILTER_OFFSET = 7,
} dnstable_stat_stage;
